function [ keep_path ] = keep_path_raytrace(map, path, too_close_to_obs, dist_gain)
% returns vector of 1 or 0 depending on whether you should keep that point in the path or not
    sample_spacing = 0.1;
    pl = length(path);
